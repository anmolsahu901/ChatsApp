...
public class MessagesAdapter extends RecyclerView.Adapter{
    ...
    public MessagesAdapter(Context context, ArrayList<MessageModal> messages, String senderRoom, String recieverRoom) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType==ITEM_SENT){
            View view = LayoutInflater.from(context).inflate(R.layout.sent_rv_item,parent,false);
            return new SendViewHolder(view);
        }
        else{
            View view = LayoutInflater.from(context).inflate(R.layout.recieve_rv_item,parent,false);
...
//        step1 : creating the object for icons or feelings
    ...
    public class SendViewHolder extends RecyclerView.ViewHolder{
        SentRvItemBinding binding;

        public SendViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = SentRvItemBinding.bind(itemView);
        }
    }

    public class RecieverViewHolder extends RecyclerView.ViewHolder{

        RecieveRvItemBinding binding;

        public RecieverViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = RecieveRvItemBinding.bind(itemView);
        }
    }
